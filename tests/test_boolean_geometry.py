...
def test_domain_canonicalizes_to_ccw_ring_with_lexicographic_start() -> None:
    ...
    assert is_canonical_region_set(region) is True
...
def test_region_set_round_trip_is_canonical_and_stable() -> None:
    ...
    assert is_canonical_region_set(raw) is False
    assert is_canonical_region_set(first) is True
    assert first == second
...
def test_intersection_can_be_empty_region_set() -> None:
    ...
    assert is_canonical_region_set(result) is True
