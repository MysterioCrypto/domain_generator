...
Этот каталог содержит сгенерированные снимки JSON Schema для семи корневых сериализуемых контрактов:
