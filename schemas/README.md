# Снимки JSON Schema — Core/Application 0.1

Этот каталог содержит сгенерированные снимки JSON Schema для девяти корневых сериализуемых контрактов:
