...
def compile_domain_spec(
    ...
    *,
    ...
    return GenerationPlan(
        ...
        surface=PlanSurface(
            moisture_base=spec.surface.moisture_base,
            water_moisture_boost=spec.surface.water_moisture_boost,
            water_moisture_decay_km=spec.surface.water_moisture_decay_km,
            moisture_noise_amplitude=spec.surface.moisture_noise_amplitude,
            moisture_noise_scale_km=spec.surface.moisture_noise_scale_km,
            vegetation_slope_zero_deg=spec.surface.vegetation_slope_zero_deg,
        ),
